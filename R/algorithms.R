...
#' 0.1n and 0.2n.  If the lengths of `tau`, `k` and `rho` are all 1, it
#' generate a linear regression sample with a single changepoint.
...
#'  being independent fair coin tosses between {-1,1}.
